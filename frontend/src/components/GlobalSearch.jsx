          ...
          {results.map((item) => (
            <li key={item.id} className="border-b border-slate-700/50 last:border-0">
              <button
                ...
                className="w-full text-left flex items-center gap-3 p-3 hover:bg-slate-700 cursor-pointer transition-colors focus:outline-none focus-visible:bg-slate-700 focus-visible:ring-2 focus-visible:ring-blue-500"
              >
                {item.avatar_url ? (
