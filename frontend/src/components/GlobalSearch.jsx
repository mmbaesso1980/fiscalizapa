          ...
          {results.length > 0 ? (
            results.map((item) => (
              <button
                ...
                className="w-full text-left flex items-center gap-3 p-3 hover:bg-slate-700 cursor-pointer border-b border-slate-700/50 last:border-0 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
              >
                {item.avatar_url ? (
            ...
            !isSearching && query.trim().length > 2 && (
              <div role="status" className="p-4 text-center text-slate-400 text-sm">
